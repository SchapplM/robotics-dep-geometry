...
% 
% [dnorm, d, lambda, mu, pg, ph] = Abstand_Gerade_Gerade(Gerade1, Gerade2)
...
% 
% Eingabe:
% Gerade1, Gerade2: 1x6 Darstellung zweier Geraden (Punkt 1,
%   Richtungsvektor)
% 
% Ausgabe:
% dnorm: Betrag des kleinsten Abstandes
% d 3x1: Vektor des kleinsten Abstandes von Gerade1 zu 2
% lambda: Parameter zum Punkt des kürzesten Abstandes auf Gerade 1:
%   Punkt = OV + lambda*RV
% mu: Parameter zum Punkt des kürzesten Abstandes auf Gerade 2:
%   Punkt = OV + mu*RV
% pg 3x1: Punkt des kürzesten Abstandes auf Gerade 1
% ph 3x1: Punkt des kürzesten Abstandes auf Gerade 2
% 
% 
% Siehe auch: 
% distanceLines3d aus geom3d Toolbox
% Abstand_Gerade_Punkt, Abstand_Punkt_Punkt,
...
% Lösung des Gleichungssysteme mit Invertierung der 2x2-Matrix
a = ug'*uh; b = -uh'*uh; c = ug'*ug; d = -uh'*ug;
ml = [d, -b; -c, a] / (a*d-b*c) * [(rh-rg)'*uh; (rh-rg)'*ug];
